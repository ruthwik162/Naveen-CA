        ...
        <ReactLenis root>
            <div className='w-full min-h-screen  md:px-[2vw] px-[5vw]  overflow-hidden'>
                <section className='xl:pt-[5vw]  h-screen lg:pt-[7vw] md:pt-[9vw] pt-[15vw]  xl:text-[5vw] grid grid-cols-6 justify-between  md:grid-cols-12 md:gap-8  gap-4 xl:leading-[5vw] text-black font-semibold font-[PPNeueMontreal]'>
                    <div className='overflow-hidden col-start-1 w-full h-full md:col-span-5 xl:col-span-3 rounded-sm aspect-video col-span-6'>
                    ...
                    <div className=' md:col-start-7  md:col-span-6 justify-between flex flex-col  items-start   col-start-2 col-span-5'>
                        <h1 className='xl:text-[3vw] xl:leading-[3vw] lg:text-[5vw] lg:leading-[5vw] font-bold md:text-[4vw] md:leading-[4vw] text-[5vw] leading-[5vw] text-indigo-500'><span className='text-black'>SANGEWAR & ASSOCIATES</span> <br />  Chartered Accountants </h1>
                        <TextY>
                    ...
                    <div className='col-start-1 col-span-6 md:col-span-12 grid grid-cols-6 md:grid-cols-12  border-t border-black/30 '>
                        ...
                        <div className='md:col-start-4 xl:col-start-4 md:col-span-9 xl:col-span-7 md:pt-[2vw] col-span-6 col-start-1 font-[Sathoshi] uppercase xl:mt-0 lg:mt-[15vw] md:mt-[5vw]'>
                            <h1 className='font-bold tracking-tight xl:text-[4.9vw] xl:leading-[4.5vw] textf  lg:text-[11.5vw] lg:leading-[10vw] md:text-[8.3vw] md:leading-[8vw] text-[9.5vw] leading-[8.5vw] '>Accounting For <span className='text-indigo-600'>Better Business</span></h1>
                        </div>
                  ...
                  text-[3vw] leading-[4vw] font-bold'>
                    ...
                    <div className='col-start-1 col-span-6 md:col-span-12 grid grid-cols-6 md:grid-cols-12 pt-[2vw] border-t border-black/30 '>
                        ...
                        <div className='md:col-start-8 md:col-span-4 xl:col-start-11  lg:col-start-8 lg:col-span-3 xl:col-span-2 col-start-4 col-span-3 text-black'>
                            <TextY>
