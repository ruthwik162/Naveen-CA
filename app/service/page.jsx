...
const services = [
  {
    ...
    tag: "STRUCTURAL",
    desc: "Foundational architecture for Private Limited, LLP, and Partnership entities. We handle the bureaucracy so you can focus on the vision.",
    icon: <Building2 size={32} strokeWidth={1} />,
  },
  {
    id: "02",
    title: "GST Ecosystems",
    tag: "TAXATION",
    desc: "End-to-end GST management. From initial registration to complex monthly filing cycles and automated compliance workflows.",
  ...
  },
  {
    ...
    tag: "STRATEGY",
    desc: "Advanced income tax planning and accurate return filing. We align your fiscal footprint with long-term growth objectives.",
  ...
  },
  {
    ...
    tag: "ASSURANCE",
    desc: "Deep-layer statutory and internal audits. We verify integrity and identify risk vulnerabilities before they become liabilities.",
  ...
  },
  {
    ...
    tag: "REGULATORY",
    desc: "Annual ROC filings, Director KYC, and legal record maintenance. Seamless adherence to the Companies Act.",
  ...
  },
  {
    ...
    tag: "ADVISORY",
    desc: "Project reports for bank funding and financial documents tailored for high-stakes loan approvals and capital scaling.",
